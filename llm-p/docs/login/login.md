...
# Ошибка просроченного токена

В случае, если для аутентификации был передан токен с истекшим сроком жизни, вызываемые методы возвращает response со 
статусом `401 - Unauthorized`.

![token_expired.png](token_expired.png)
